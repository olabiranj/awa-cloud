  ...
  axios
    ...
    .catch((err) => {
      dispatch({
        type: "SET_ERROR",
        payload:
          "Weather informations about the location you entered could not be found, Kindly search for another city.",
      });
      dispatch({
        type: "SET_CITY_LOADING",
      });
  ...
  axios
    ...
    .catch((err) => {
      dispatch({
        type: "SET_ERROR",
        payload:
          "Weather informations about your current location could not be found, Kindly search for another city.",
      });
      dispatch({
        type: "SET_CITY_LOADING",
      });
