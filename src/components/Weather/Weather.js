...
const Weather = () => {
  ...
  return (
    <>
      <div className="container bg-light bg-skeleton col-lg-5"></div>
            ...
            {weather.city.map((city) => (
              <div data-testid="weatherDiv" key="der">
                <div className="text-center">
                  ...
                  <h1 className="text-light head">
                    {toCelcius(
                      city.DailyForecasts[0].Temperature.Minimum.Value
                    )}
                    &deg;
                  </h1>
                  <p className="text-light">
                    ...
                    &deg;/
                    {toCelcius(
                      city.DailyForecasts[0].Temperature.Maximum.Value
                    )}
                    &deg;
                  </p>
                  <img
                    src={weatherImage(city.DailyForecasts[0].Day.Icon)}
                    alt=""
                    height="100"
                  />
                </div>
                <div className="div-down text-center">
                  ...
                  <div className="container day">
                    ...
                    <div className="flag-2">
                      <img
                        src={weatherImage(city.DailyForecasts[1].Day.Icon)}
                        alt=""
                        height="30"
                      />
                    </div>
                    <div className="flag-2">
                      <p className="text-light">
                        {toCelcius(
                          city.DailyForecasts[1].Temperature.Minimum.Value
                        )}
                        &deg;/
                        {toCelcius(
                          city.DailyForecasts[1].Temperature.Maximum.Value
                        )}
                        &deg;
                      </p>
                    </div>
                  ...
                  <div className="container day">
                    ...
                    <div className="flag-2">
                      <p className="text-light">
                        {toCelcius(
                          city.DailyForecasts[2].Temperature.Minimum.Value
                        )}
                        &deg;/
                        {toCelcius(
                          city.DailyForecasts[2].Temperature.Maximum.Value
                        )}
                        &deg;
                      </p>
                    </div>
                  ...
                  <div className="container day">
                    ...
                    <div className="flag-2">
                      <img
                        src={weatherImage(city.DailyForecasts[3].Day.Icon)}
                        alt=""
                        height="30"
                      />
                    </div>
                    <div className="flag-2">
                      <p className="text-light">
                        {toCelcius(
                          city.DailyForecasts[3].Temperature.Minimum.Value
                        )}
                        &deg;/
                        {toCelcius(
                          city.DailyForecasts[3].Temperature.Maximum.Value
                        )}
                        &deg;
                      </p>
                    </div>
                  ...
                  <div className="container day">
                    ...
                    <div className="flag-2">
                      <img
                        src={weatherImage(city.DailyForecasts[4].Day.Icon)}
                        alt=""
                        height="30"
                      />
                    </div>
                    <div className="flag-2">
                      <p className="text-light">
                        {toCelcius(
                          city.DailyForecasts[4].Temperature.Minimum.Value
                        )}
                        &deg;/
                        {toCelcius(
                          city.DailyForecasts[4].Temperature.Maximum.Value
                        )}
                        &deg;
                      </p>
                    </div>
