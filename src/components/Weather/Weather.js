                ...
                {weather.loading ? (
                    <>
                        <div className="text-center">
                            ...
                            <h1 className="text-light head d-opacity">
                                0&deg;
                            </h1>
                            <p className="text-light d-opacity">
                                0&deg;/0&deg;
                            </p>
                            <img
                                className="d-opacity"
                            ...
                            <div data-testid="weatherDiv" key="der">
                                <div className="text-center">
                                    ...
                                    <h1 className="text-light head">
                                        {toCelcius(
                                            city.DailyForecasts[0].Temperature
                                                .Minimum.Value
                                        )}
                                        &deg;
                                    </h1>
                                    ...
                                    <img
                                        src={weatherImage(
                                            city.DailyForecasts[0].Day.Icon
                                        )}
                                        alt=""
                                        height="100"
                                    />
